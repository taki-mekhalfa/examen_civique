...
class AppColors {
  ...
  static const Color primaryGreyLight = Color(0xFFFBFBFA);
  static const Color primaryNavyBlue = Color(0xFF0B3B65);
  ...
  static const Color fluorescentGreen = Color.fromARGB(255, 176, 234, 176);
